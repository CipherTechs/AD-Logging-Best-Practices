...
if (-not (Test-Path "$env:windir\system32\CustomEventChannels.dll")) {
    Copy-Item c:\WEF\windows-event-forwarding-master\windows-event-channels\CustomEventChannels.dll "$env:windir\system32"
    Copy-Item c:\WEF\windows-event-forwarding-master\windows-event-channels\CustomEventChannels.man "$env:windir\system32"
    ...
    cd c:\WEF\windows-event-forwarding-master\wef-subscriptions
